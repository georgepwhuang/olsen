...
from olsen.datamod.datamodule import DocumentClassificationDataWithSupervisedUDA
...
parser.add_lightning_class_args(DocumentClassificationDataWithSupervisedUDA, "data")
...
data = DocumentClassificationDataWithSupervisedUDA(**vars(args.data))
